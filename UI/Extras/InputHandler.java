...
public class InputHandler implements com.badlogic.gdx.InputProcessor {
    ...
    private static Integer xDown = 0, yDown = 0;
    private static Integer xUp = 0, yUp = 0;
    ...
    public static Integer getxDown() {
        return xDown;
    }

    public static Integer getyDown() {
        return yDown;
    }

    public static Integer getxUp() {
        return xUp;
    }

    public static Integer getyUp() {
        return yUp;
    }
